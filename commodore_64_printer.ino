...
int CBM_ATN_OUT    = 7;      // Arduino's digital I/O pin 9.
int CBM_RESET_OUT  = 8;     // Arduino's digital I/O pin 10.
int CBM_CLK_OUT    = 10;     // Arduino's digital I/O pin 11.
int CBM_DATA_IN    = 11;     // Arduino's digital I/O pin 12.
int CBM_DATA_OUT   = 12;     // Arduino's digital I/O pin 13 (+LED).
...
int CBM_PRN_ADDR_2 = CMB_PRN_MODE_GRAPHIC; // 2nd addr = printer mode.
...
void cbm_println(char* text)
{
  ...
  cbm_serial_write_frame(10, 0); // line feed
  cbm_serial_write_frame(13, 0); // carriage return
}
